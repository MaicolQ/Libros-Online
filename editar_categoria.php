...
if (
  ...
  #El ID de categoria no esta configurado
  if (!isset($_GET['id'])) {
  ...
  $categorias = get_categoria($conn, $id);
  ...
  <body>
    <div class="container">
      ...
      <!--estilos en el autor-->
      <form action="php/editar_categoria.php" method="post" class="shadow p-4 rounded mt-5"
        ...
        <div class="mb-3">
          ...
          <input type="text" value="<?= $categorias['id'] ?>" hidden name="categoria_id">
          <input type="text" class="form-control" value="<?= $categorias['nombre'] ?>" name="nombre_categoria">
        </div>
