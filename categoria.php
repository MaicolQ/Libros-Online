<?php
session_start();
#si no se establece el ID de Categoria
if (!isset($_GET['id'])) {
  header("Location: index.php");
  exit;
}

#Obtener ID de categoría de la solicitud GET
$id = $_GET['id'];
...
$libros = get_books_by_category($conn, $id);
...
<head>
  ...
  <title><?= $current_categoria['nombre'] ?></title>
